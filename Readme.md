...
Cuda .cu file.  The parameters are specified using a Jvav and C style declaration.
...
additional coding to calcualte and print the times associated with eaach phase of 
the application.
...
way they are structured internally and the somewhat bizzare way user code can refer 
